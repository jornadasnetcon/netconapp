...
class Cupones extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sorteo:cupones {prices_file}';
     ...
     * @var string
     */
    protected $description = 'Assign one voucher to the file to one participant';
    ...
    public function handle()
    {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
            ...
            $new_prices[] = [
                ...
                'description' => "Cupón de descuento en la web de PEG (https://www.peginc.com). Solo aplicable a productos Pinnacle y no acumulable con otras ofertas. Fecha de caducidad: 30/06/2020",
                'code' => $price["Premio"],
            ];

            $user = User::find($participant);
            Mail::to($user)->send(new PriceReceivedEmail($user, false));
        }
